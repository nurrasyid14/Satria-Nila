...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd services/ml-service; uvicorn app.main:app --host 127.0.0.1 --port 8001 --reload"

# Jalankan Data Service di background
Write-Host "Starting Data Service on port 8002..." -ForegroundColor Green
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd services/data-service; uvicorn app.main:app --host 127.0.0.1 --port 8002 --reload"
